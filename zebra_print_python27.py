# python  .\zebra_print_python27.py --variable_file .\variables_4.txt .\4_units.txt --printer Zebra34

# python  .\zebra_print_python27.py --variable_file .\variables_6.txt .\6_units.txt --printer Zebra34
...
if __name__ == "__main__":
    ...
    if args.printer is None:
        if dflt is None:
            printers = get_printers()
            if printers:
                print 'No default printer is available. Please specify a valid printer with the --printer argument.'
    ...
    with open(args.file, 'r') as fh:
        try:
            ...
            print 'Some variables specified in the PRN text are not supplied in the "%s" file.' % args.variable_file
